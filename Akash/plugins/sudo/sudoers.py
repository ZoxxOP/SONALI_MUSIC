...
from Akash.misc import SUDOERS
from Akash.utils.database import add_sudo, remove_sudo
from Akash.utils.decorators.language import language
from Akash.utils.extraction import extract_user
...
async def sudoers_list(client, message: Message):
    ...
    await message.reply_photo(video="https://files.catbox.moe/g7870t.jpg", caption="**» ᴄʜᴇᴄᴋ sᴜᴅᴏ ʟɪsᴛ ʙʏ ɢɪᴠᴇɴ ʙᴇʟᴏᴡ ʙᴜᴛᴛᴏɴ.**\n\n**» ɴᴏᴛᴇ:**  ᴏɴʟʏ sᴜᴅᴏ ᴜsᴇʀs ᴄᴀɴ ᴠɪᴇᴡ. ", reply_markup=reply_markups)
...
async def check_sudo_list(client, callback_query: CallbackQuery):
    ...
    if callback_query.from_user.id not in SUDOERS:
        return await callback_query.answer("𝐀ᴋᴀsʜ ᴋᴀ 𝐋ᴜɴᴅ 𝐋ᴇɢᴀ 😂 \n 𝐒ᴜᴅᴏʟɪsᴛ 𝐃ᴇᴋʜɴᴇ ᴀᴀʏᴀ ᴍᴄ 🤧🖕", show_alert=True)
    else:
